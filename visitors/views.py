...
def visitor(request):
    ...
    if request.is_ajax():
        ...
        cap = cv2.VideoCapture(
            "E:\Downloads\Major project\customertracker\visitors\Person.py")
        ...
        ##    frame = image.array
            ...
            try:
                ...
                ret, imBin2 = cv2.threshold(
                    fgmask2, 200, 255, cv2.THRESH_BINARY)
            ...
            cv2.putText(frame, "MechatronicsLAB.net",
                        (300, 200), font, 1, (255, 0, 0), 2)
